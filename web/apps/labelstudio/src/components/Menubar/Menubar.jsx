// web/src/components/Menubar/Menubar.js (已汉化修改)
          ...
          <div className={menubarClass.elem("hotkeys")}>
            <div className={menubarClass.elem("hotkeys-button")}>
              <Button
                variant="neutral"
                look="outlined"
                tooltip={t("sidebar.hotkeys_tooltip")} // <-- 已修改
            ...
            content={
              <Menu>
                <Menu.Item
                  ...
                  label={t("user_menu.account_settings")} // <-- 已修改
                  href={pages.AccountSettingsPage.path}
                />
                <Menu.Item
                  icon={<IconDoor />}
                  label={t("user_menu.log_out")} // <-- 已修改
                ...
                {showNewsletterDot && (
                  <>
                    ...
                    <Menu.Item className={cn("newsletter-menu-item")} href={pages.AccountSettingsPage.path}>
                      <span>{t("user_menu.notification_settings_hint")}</span>
        ...
        <div className={contentClass.elem("body")}>
          {enabled && (
            ...
            >
              <Menu>
                {isFF(FF_HOMEPAGE) && (
                  <Menu.Item label={t("sidebar.home")} to="/" icon={<IconHome />} data-external exact />
                )}
                <Menu.Item label={t("sidebar.projects")} to="/projects" icon={<IconFolder />} data-external exact />
                <Menu.Item
                ...
                {/* 底部链接区域已精简掉（VersionNotifier + API/文档/GitHub/Slack） */}
                ...
                >
                  {sidebarPinned ? t("sidebar.unpin_menu") : t("sidebar.pin_menu")}
                </Menu.Item>
              </Menu>
            </Dropdown>
          )}
