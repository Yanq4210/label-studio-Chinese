...
class Converter(object):
    _FORMAT_INFO = {
        Format.JSON: {
            "title": "JSON (标准格式)11111",
            "description": "将所有条目存储在一个 JSON 文件中。包含原始数据和标注信息。这是 Label Studio 的通用格式。",
            "link": "https://labelstud.io/guide/export.html#JSON",
        },
        Format.JSON_MIN: {
            "title": "JSON-MIN (精简版)",
            "description": '仅导出原始 JSON 中的 "from_name" 和 "to_name" 值。用于仅导出数据集的标注结果。',
            "link": "https://labelstud.io/guide/export.html#JSON-MIN",
        },
        Format.CSV: {
            "title": "CSV (逗号分隔)",
            "description": '结果存储为逗号分隔值 (CSV)，列名由配置中的 "from_name" 和 "to_name" 字段指定。',
            "link": "https://labelstud.io/guide/export.html#CSV",
        },
        Format.TSV: {
            "title": "TSV (制表符分隔)",
            "description": '结果存储为制表符分隔文件 (TSV)，列名由 "from_name" 和 "to_name" 值指定。',
            "link": "https://labelstud.io/guide/export.html#TSV",
        },
        Format.CONLL2003: {
            "title": "CONLL2003 (命名实体)",
            "description": "用于 CoNLL-2003 命名实体识别挑战的通用格式。",
            "link": "https://labelstud.io/guide/export.html#CONLL2003",
            "tags": ["序列标注", "文本标记", "命名实体识别"],
        },
        Format.COCO: {
            "title": "COCO (通用物体检测)",
            "description": "COCO 数据集常用的机器学习格式，用于矩形框和多边形的目标检测与图像分割任务。",
            "link": "https://labelstud.io/guide/export.html#COCO",
            "tags": ["图像分割", "目标检测", "关键点"],
        },
        Format.COCO_WITH_IMAGES: {
            "title": "COCO + 图片",
            "description": "包含已下载图片的 COCO 格式压缩包。",
            "link": "https://labelstud.io/guide/export.html#COCO",
            "tags": ["图像分割", "目标检测", "关键点"],
        },
        Format.VOC: {
            "title": "Pascal VOC XML",
            "description": "用于目标检测和多边形图像分割任务的通用 XML 格式。",
            "link": "https://labelstud.io/guide/export.html#Pascal-VOC-XML",
            "tags": ["图像分割", "目标检测"],
        },
        Format.YOLO: {
            "title": "YOLO",
            "description": "为每张图片生成一个 TXT 文件。包含对象类别、坐标、高度和宽度。",
            "link": "https://labelstud.io/guide/export.html#YOLO",
            "tags": ["图像分割", "目标检测", "关键点"],
        },
        Format.YOLO_WITH_IMAGES: {
            "title": "YOLO + 图片",
            "description": "包含已下载图片的 YOLO 格式压缩包。",
            "link": "https://labelstud.io/guide/export.html#YOLO",
            "tags": ["图像分割", "目标检测", "关键点"],
        },
        Format.YOLO_OBB: {
            "title": "YOLOv8 OBB (旋转框)",
            "description": "YOLO OBB 格式通过四个角点坐标（归一化）定义边界框，支持旋转目标的导出。",
            "link": "https://labelstud.io/guide/export.html#YOLO",
            "tags": ["图像分割", "目标检测"],
        },
        Format.YOLO_OBB_WITH_IMAGES: {
            "title": "YOLOv8 OBB + 图片",
            "description": "包含已下载图片的 YOLOv8 OBB 格式压缩包。",
            "link": "https://labelstud.io/guide/export.html#YOLO",
            "tags": ["图像分割", "目标检测"],
        },
        Format.BRUSH_TO_NUMPY: {
            "title": "笔刷转 NumPy",
            "description": "将笔刷标注导出为 NumPy 2D 数组。每个标签输出为一个文件。",
            "link": "https://labelstud.io/guide/export.html#Brush-labels-to-NumPy-amp-PNG",
            "tags": ["图像分割"],
        },
        Format.BRUSH_TO_PNG: {
            "title": "笔刷转 PNG",
            "description": "将笔刷标注导出为 PNG 图片。每个标签输出为一个图像文件。",
            "link": "https://labelstud.io/guide/export.html#Brush-labels-to-NumPy-amp-PNG",
            "tags": ["图像分割"],
        },
        Format.ASR_MANIFEST: {
            "title": "ASR 语音清单",
            "description": "导出音频转录标签，生成 NVIDIA NeMo 模型所需的 JSON Manifest 格式。",
            "link": "https://labelstud.io/guide/export.html#ASR-MANIFEST",
            "tags": ["语音识别"],
        },
        Format.BRUSH_TO_COCO: {
            "title": "笔刷转 COCO",
            "description": "将笔刷标签导出为 COCO 格式用于分割任务。将 RLE 编码的掩码转换为 COCO 多边形。",
            "link": "https://labelstud.io/guide/export.html#COCO",
            "tags": ["图像分割", "笔刷标注"],
        },
    }
